    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg">
        ...
        <form action="{{ route('productivity.store') }}" method="POST" class="mx-6 my-4">
            ...
            <div class="mb-4">
                ...
                <x-input id="general_cargo" name="general_cargo" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="bag_cargo" name="bag_cargo" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="unitized" name="unitized" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="truck_lossing" name="truck_lossing" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="pipa_lossing" name="pipa_lossing" type="number" class="block w-full mt-3"
