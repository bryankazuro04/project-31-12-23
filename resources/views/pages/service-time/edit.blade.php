    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg">
        ...
        <form action="{{ route('service-time.update', [$service_time]) }}" method="POST" class="mx-6 my-4">
            ...
            <div class="mb-4">
                ...
                <x-input id="waiting_time_pilot" name="waiting_time_pilot" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="waiting_time_dermaga" name="waiting_time_dermaga" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="wt_gross" name="wt_gross" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="postpone_time" name="postpone_time" type="number" class="block w-full mt-3"
            ...
            <div class="mb-4">
                ...
                <x-input id="approach_time" name="approach_time" type="number" class="block w-full mt-3"
