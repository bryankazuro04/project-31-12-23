...
export const utilizationOccupancyRatioChart = () => {
  const ctx = document.getElementById("utilizationOccupancyRatioChart");
  if (!ctx) return;
  ...
  fetch("/api/utilization-data")
    .then((response) => response.json())
    .then((data) => {
      const bor = data.map((item) => item.bor),
        yor = data.map((item) => item.yor),
        sor = data.map((item) => item.sor);
      ...
      const myData = [
        {
          label: "Data Berth Occupancy Ratio",
          data: bor,
          backgroundColor: "rgb(54, 162, 235)",
        },
        {
          label: "Data Yard Occupancy Ratio",
          data: yor,
          backgroundColor: "#6F00FF",
        },
        {
          label: "Data Shed Occupancy Ratio",
          data: sor,
          backgroundColor: "rgb(25, 245, 215)",
        },
      ];
      ...
      new Chart(ctx, {
        ...
        options: {
          ...
          plugins: {
            ...
            htmlLegend: {
              containerId: "utilization-occupancy_ratio-data-legend",
            },
            tooltip: {
              callbacks: {
