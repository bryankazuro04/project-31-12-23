...
export const trafficLOAChart = () => {
  const ctx = document.getElementById("trafficLOAChart");
  if (!ctx) return;
  ...
  fetch("/api/traffic-data")
    ...
    .then((data) => {
      let loa = data.map((item) => parseFloat(item.loa));
      ...
      const myData = [
        {
          label: "Data Rata-rata LOA",
          data: loa,
          borderColor: darkMode ? borderColor.dark : borderColor.light,
          backgroundColor: darkMode ? borderColor.dark : borderColor.light,
        },
      ];
      ...
      new Chart(ctx, {
        ...
        options: {
          ...
          plugins: {
            ...
            htmlLegend: {
              containerId: "traffic-loa-data-legend",
            },
            tooltip: {
              callbacks: {
            ...
            afterUpdate(c, args, options) {
              ...
              items.forEach((item) => {
                ...
                const theValue = totalValue.reduce((a, b) => a + b),
                  valueText = document.createTextNode(`${theValue} meter`),
